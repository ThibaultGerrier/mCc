...
void symbol_table_add_built_in_functions(
    const struct mCc_ast_symbol_table_visitor_data *visit_data)
{
	...
	struct mCc_ast_identifier *identifier_print = mCc_ast_new_identifier(a[0]);
	...
	mCc_sym_table_add_entry(&visit_data->stack->symbol_table_tree->symbol_table,
	                        new_entry_print);
	...
	new_entry_print_nl->function_def =
	    mCc_ast_new_function_def(MCC_AST_TYPE_VOID, identifier_nl, NULL, NULL);
	mCc_sym_table_add_entry(&visit_data->stack->symbol_table_tree->symbol_table,
	                        new_entry_print_nl);
	...
	struct mCc_ast_declaration *declaration_print_int =
	    mCc_ast_new_declaration(MCC_AST_TYPE_INT, mCc_ast_new_identifier("x"));
	...
	new_entry_print_float->function_def = mCc_ast_new_function_def(
	    MCC_AST_TYPE_VOID, identifier_print_float, parameter_print_float, NULL);
	mCc_sym_table_add_entry(&visit_data->stack->symbol_table_tree->symbol_table,
